...
class ImageData {
     ...
     * @throws {Error} If the object argument is missing required data parameter
     * @throws {Error} If the object argument is missing required width parameter
     * @throws {Error} If the object argument is missing required height parameter
     */
    constructor(object) {
        ...
        required.forEach(param => {
            if (typeof object[param] === 'undefined') {
                throw new Error(`Argument object is missing required "${param}" parameter`)
            }
        })
